...
namespace Mapsui.Samples.Common
{
    public static class StyleSamples
    {
        ...
        public static IStyle CreateMyColoredLabelStyle(string label)
        {
            return new LabelStyle { Text = label, BackColor = new Brush(Color.Red), ForeColor = Color.White, Halo = new Pen(Color.Red, 4) };
        }
     }
}
